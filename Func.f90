module Func
contains
  !The dimensionless gravitational potential, currently only a function of r
  function f(r)
    implicit none
  ...
  subroutine RK8(f, r, v, t, h)
    implicit none

    real*8 :: k1_1, k1_2, k1_3, k1_4, k1_5, k1_6, k1_7, k1_8, k1_9, k1_10
    real*8 :: k2_1, k2_2, k2_3, k2_4, k2_5, k2_6, k2_7, k2_8, k2_9, k2_10
    real*8 :: r, v
    real*8 :: t, h
